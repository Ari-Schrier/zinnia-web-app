...
const apiKey = 'sk-proj-VmiTylDJwrSAMJHw387BT3BlbkFJd8SLMKzJ1nHu640DizZx' //process.env.REACT_APP_SECRET_KEY;
...
[
  {
    ...
    "question": ["A simple question which a caretaker might ask a dementia patient looking at this photograph. These questions should not focus on specifics-- they should help facilitate a conversation.", "the same question, translated into Spanish", "The same question, translated into French"],
...
const questionPreamble = `You are a helpful assistant who assists users brainstorm slideshows to be shown to dementia patients. When you are given a title for a slideshow, you suggest five questions and accompanying photographs which might be asked in a slideshow with that title. These slideshows are intended to be viewed by dementia patients. All images should be nostalgic and non-threatening. For each photograph you generate, start by choosing a subject. Avoid any subjects which might frighten a viewer or be difficult to generate with AI. Most photographs should not focus on humans. Your response will be formatted as a JSON array and should look like this:

[
  {
    "title": "title of photograph. Should be short and descriptive",
    "question": ["A simple question which a caretaker might ask a dementia patient looking at this photograph. These questions should not focus on specifics-- they should help facilitate a conversation.", "the same question, translated into Japanese", "The same question, translated into French"],
    "description": "We want our descriptions to be simple. Limit use of adjectives. Just include the object being focused on and the background. This should end with a comma"
    "lens": "Choose ONE between sigma 85mm f/1.4, Sigma 85mm f/8, and Sigma 24mm f/8"
  },
  {Repeat for photos two and three}
